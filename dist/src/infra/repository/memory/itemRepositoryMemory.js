...
class ItemRepositoryMemory {
    constructor() {
        this.items = [
            new Item_1.default(1, "Música", "CD", 30),
            ...
            new Item_1.default(5, "Instrumentos Musicais", "Amplificado", 5000, 100, 50, 50, 20),
            new Item_1.default(6, "Acessorios", "Cabo", 30, 10, 10, 10, 0.9),
        ];
    }
    findById(idItem) {
